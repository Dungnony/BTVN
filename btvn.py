...
# Thêm radio button để chọn "Là nhân viên" hoặc "Là khách hàng"
role_var = tk.StringVar(value="Nhân viên")  # Mặc định là "Nhân viên"
tk.Radiobutton(root, text="Nhân viên", variable=role_var, value="Nhân viên").grid(row=9, column=1)
tk.Radiobutton(root, text="Khách hàng", variable=role_var, value="Khách hàng").grid(row=9, column=2)
data = {
    "Tên nhân viên": [],
    "Ngày sinh": [],
    "CMND": [],
